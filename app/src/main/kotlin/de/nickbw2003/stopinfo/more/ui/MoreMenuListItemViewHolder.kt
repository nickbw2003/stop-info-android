...
import kotlinx.android.synthetic.main.item_view_more_menu.view.*

class MoreMenuListItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    fun bind(menuEntry: MoreMenuEntry, onItemClick: ((menuEntry: MoreMenuEntry) -> Unit)?) = with(itemView) {
        ...
        menu_entry_title.text = context.getString(menuEntry.titleStringResource)
    }
}